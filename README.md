...
This repository contains two raytracer programs written in [Turbo Pascal](https://en.wikipedia.org/wiki/Turbo_Pascal) for MS-DOS: text mode (default is 80x25) and graphics mode (640x480). The algorithm is based on the BASIC programs for BBC Micro by [Steve McCrea](https://twitter.com/Kweepa).
